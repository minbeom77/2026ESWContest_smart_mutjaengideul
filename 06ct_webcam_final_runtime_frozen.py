...
FILE_TAG = "[최종 런타임 후보 / C4 + 2353-1152 MID40 통합 검증 중]"
...
C4_EXPECTED_SIGN_REFERENCES = 267
C4_EXPECTED_NOSIGN_REFERENCES = 308

C4_EXPECTED_SHA256 = (
    "ce880402db3e3b16bf6d448a511518246691ce8b7c8f522fc1daa9cea0ed400a"
)
...
ONEHAND_CALIBRATION_PATH = os.path.join(
    BASE_DIR,
    "template_runtime_v3",
    "06am_onehand4_webcam_calibration_28.npz",
)
...
C4_FROZEN_PATH = os.path.join(
    BASE_DIR,
    "diagnostics_v3",
    "06ce_frozen_onehand_sign_nosign_c4_model.npz",
)
...
# ============================================================
# One-hand 4-class Webcam calibration
#
# 06am:
#
# 2353 ×7
...
def load_frozen_c4_gate():
    ...
    if (
        frozen_status
        !=
        "FROZEN_FOR_INDEPENDENT_FRESH_VALIDATION"
    ):
...
def print_startup_info():
    ...
    print(
        "06cj WEBCAM FINAL HIERARCHY "
        "+ FROZEN C4 NO-SIGN GATE"
    )
    ...
    print(
        "   → class-balanced K=3 mean distance"
    )
    ...
    print()
    print(
        "2) C4가 SIGN이면 기존 one-hand4"
    )


    print(
        "   → 06am webcam calibration 28"
    )
    ...
    print(
        "  → SIGN일 때 4-class webcam fallback"
    )
    ...
    print(
        "ONE-HAND NO-SIGN rejection: APPLIED"
    )
